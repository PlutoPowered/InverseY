...
public interface Function6<R, P1, P2, P3, P4, P5, P6> extends FunctionX<R>, DangerousFunction6<R, RuntimeException, P1, P2, P3, P4, P5, P6> {
    ...
    @Override
    default void accept(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6) {
