...
public interface DangerousFunction7<R, T extends Throwable, P1, P2, P3, P4, P5, P6, P7> extends DangerousFunctionX<R, T>, DangerousConsumer7<T, P1, P2, P3, P4, P5, P6, P7> {

    R apply(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7) throws T;
    ...
    @Override
    default void accept(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5, P6 p6, P7 p7) throws T {
